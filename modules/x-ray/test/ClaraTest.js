System.register(["./SimpleGUI", "../core/src/ThreeJSView", "../core/src/XRayView", "../core/src/engine/renderer/worker/Thread", "../core/src/engine/utils/MathUtils"], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            ClaraTest = (function (_super) {
                __extends(ClaraTest, _super);
                function ClaraTest() {
                    _super.call(this);
                ...
                ClaraTest.prototype.onInit = function () {
                    var _this = this;
                    var self = this;
                    ...
                    objectLoader.load("../../../models/porsche-cayman-vray-threejs/porsche-cayman-vray.json", function (obj) {
                ...
                ClaraTest.prototype.render = function () {
                    this.threeJSView.render();
                };
                ClaraTest.prototype.toggleGI = function (newValue) {
                ...
                ClaraTest.prototype.toggleTrace = function (newValue) {
                    this.giJSView.toggleTrace(newValue);
                };
                return ClaraTest;
            }(SimpleGUI_1.SimpleGUI));
            exports_1("ClaraTest", ClaraTest);
        }
    }
});
//# sourceMappingURL=ClaraTest.js.map