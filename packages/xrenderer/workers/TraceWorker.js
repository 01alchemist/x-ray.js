System.register(["xrenderer"], function(exports_1, context_1) {
    "use strict";
        ...
        execute: function() {
            TraceWorker = (function () {
                ...
                TraceWorker.prototype.onMessageReceived = function (e) {
                    ...
                    switch (data.command) {
                        ...
                        case xrenderer_1.TraceJob.TRACE:
                            ...
                            postMessage(xrenderer_1.TraceJob.TRACED);
                            break;
                    }
                };
                ...
                TraceWorker.prototype.lock = function () {
                    if (!this.locked) {
                        this.locked = true;
                        postMessage(xrenderer_1.TraceJob.LOCKED);
                    }
                };
