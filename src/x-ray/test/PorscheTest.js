System.register(["./SimpleGUI", "../core/src/ThreeJSView", "../core/src/XRayView", "../core/src/engine/renderer/worker/Thread", "../core/src/engine/utils/MathUtils"], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            PorscheTest = (function (_super) {
                __extends(PorscheTest, _super);
                function PorscheTest() {
                    _super.call(this);
                    Thread_1.Thread.workerUrl = "../workers/trace-worker-bootstrap-debug.js";
                    this.i_width = 2560 / 4;
                    this.i_height = 1440 / 4;
                }
                PorscheTest.prototype.onInit = function () {
                    var _this = this;
                    var self = this;
                ...
                PorscheTest.prototype.render = function () {
                    this.threeJSView.render();
                };
                PorscheTest.prototype.toggleGI = function (newValue) {
                ...
                PorscheTest.prototype.toggleTrace = function (newValue) {
                    this.giJSView.toggleTrace(newValue);
                };
                return PorscheTest;
            }(SimpleGUI_1.SimpleGUI));
            exports_1("PorscheTest", PorscheTest);
        }
    }
});
//# sourceMappingURL=PorscheTest.js.map