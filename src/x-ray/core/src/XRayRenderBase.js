        ...
        execute: function() {
            XRayRenderBase = (function (_super) {
                ...
                XRayRenderBase.prototype.render = function (onInit) {
                    ...
                    var self = this;
                    this.pixels = this.renderer.render(this.scene.scenePtr, this.camera, this.i_width, this.i_height, this.cameraSamples, this.hitSamples, this.bounces, this.iterations, this.blockIterations, onUpdate, updateIndicator, onInit);
