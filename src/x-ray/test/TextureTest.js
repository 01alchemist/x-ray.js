    ...
    return {
        ...
        execute: function() {
            TextureTest = (function (_super) {
                ...
                TextureTest.prototype.onInit = function () {
                    var _this = this;
                    var self = this;
                    ...
                    self.render();
                    var name = "bag_chair";
                    var folder = "bag_chair/";
                    var mtlLoader = new THREE["MTLLoader"](manager);
                    mtlLoader.setBaseUrl('../../../models/' + folder);
                ...
                TextureTest.prototype.render = function () {
                    this.threeJSView.render();
                };
                TextureTest.prototype.toggleGI = function (newValue) {
                ...
                TextureTest.prototype.toggleTrace = function (newValue) {
                    this.giJSView.toggleTrace(newValue);
                };
                return TextureTest;
            }(SimpleGUI_1.SimpleGUI));
            exports_1("TextureTest", TextureTest);
        }
    }
});
