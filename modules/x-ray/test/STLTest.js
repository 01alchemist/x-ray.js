System.register(["./SimpleGUI", "../core/src/ThreeJSView", "../core/src/XRayView", "../core/src/engine/renderer/worker/Thread", "../core/src/engine/utils/MathUtils", "../core/src/engine/math/Color"], function(exports_1, context_1) {
    "use strict";
    ...
    var SimpleGUI_1, ThreeJSView_1, XRayView_1, Thread_1, MathUtils_1, Color_1;
    var STLTest;
    return {
        setters:[
        ...
        execute: function() {
            STLTest = (function (_super) {
                __extends(STLTest, _super);
                function STLTest() {
                    _super.call(this);
                    Thread_1.Thread.workerUrl = "../../../modules/x-ray/workers/trace-worker-bootstrap-debug.js";
                    this.i_width = 2560 / 2;
                    this.i_height = 1440 / 2;
                }
                STLTest.prototype.onInit = function () {
                    var _this = this;
                    var self = this;
                    ...
                    this.giJSView.scene.color = Color_1.Color.hexColor(0xFDDCBA);
                    ...
                    loader.load('../../../models/stl/Buddas_Gold.stl', function (geometry) {
                        ...
                        material.ior = 1;
                        material.gloss = MathUtils_1.MathUtils.radians(10);
                        var mesh = new THREE.Mesh(geometry, material);
                        mesh.smooth = true;
                ...
                STLTest.prototype.render = function () {
                    this.threeJSView.render();
                };
                STLTest.prototype.toggleGI = function (newValue) {
                ...
                STLTest.prototype.toggleTrace = function (newValue) {
                    this.giJSView.toggleTrace(newValue);
                };
                return STLTest;
            }(SimpleGUI_1.SimpleGUI));
            exports_1("STLTest", STLTest);
        }
    }
});
//# sourceMappingURL=STLTest.js.map