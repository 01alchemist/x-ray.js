System.register(["./SimpleGUI", "../core/src/ThreeJSView", "../core/src/XRayView", "../core/src/engine/renderer/worker/Thread", "../core/src/engine/utils/MathUtils"], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            ColladaTest = (function (_super) {
                __extends(ColladaTest, _super);
                ...
                ColladaTest.prototype.onInit = function () {
                    var _this = this;
                    var self = this;
                ...
                ColladaTest.prototype.render = function () {
                    this.threeJSView.render();
                };
                ColladaTest.prototype.toggleGI = function (newValue) {
                ...
                ColladaTest.prototype.toggleTrace = function (newValue) {
                    this.giJSView.toggleTrace(newValue);
                };
                return ColladaTest;
            }(SimpleGUI_1.SimpleGUI));
            exports_1("ColladaTest", ColladaTest);
        }
    }
});
//# sourceMappingURL=ColladaTest.js.map