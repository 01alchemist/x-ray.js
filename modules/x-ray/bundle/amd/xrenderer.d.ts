...
declare module "core/src/engine/math/Vector3" {
    ...
    export class Vector3 {
        ...
        static SIMD: {
            ...
            cross: (a: any, b: any) => SIMD.Float32x4;
        };
        data: Float32Array;
        ...
        SIMD_dot(_b: any): number;
        cross(b: Vector3): Vector3;
        SIMD_cross(_b: any): SIMD.Float32x4;
        normalize(): Vector3;
        add(b: Vector3): Vector3;
        sub(b: Vector3): Vector3;
        SIMD_sub(_b: any): SIMD.Float32x4;
...
declare module "core/src/HeadlessRenderBase" {
    ...
    export class HeadlessRenderBase {
        ...
        dirty: boolean;
        constructor(i_width: number, i_height: number, outmemory?: Uint8Array);
        updateCameraSamples(newValue: number): void;
        updateHitSamples(newValue: number): void;
        updateCamera(newValue: any): void;
        updateCameraMatrix(matrix: number[]): void;
        toggleTrace(newValue: boolean): void;
        render(onInit?: Function, onUpdate?: Function): void;
        setResolution(width: number, height: number): void;
...
declare module "core/core" {
    ...
    export * from "core/src/HeadlessRenderBase";
