...
Texture.bilinearSample = function (SELF, u, v) {
    var _w = turbo.Runtime._mem_int32[(SELF + 12) >> 2];
    var w = _w - 1;
    var h = turbo.Runtime._mem_int32[(SELF + 8) >> 2] - 1;
    var f = u * w;
    var X = Math.floor(f);
    var x = f - X;
    f = v * h;
    ...
    var c00 = turbo.Runtime._mem_int32[((turbo.Runtime._mem_int32[(SELF + 4) >> 2]) + 4 * i00) >> 2];
    var c01 = turbo.Runtime._mem_int32[((turbo.Runtime._mem_int32[(SELF + 4) >> 2]) + 4 * i01) >> 2];
    var c10 = turbo.Runtime._mem_int32[((turbo.Runtime._mem_int32[(SELF + 4) >> 2]) + 4 * i10) >> 2];
    var c11 = turbo.Runtime._mem_int32[((turbo.Runtime._mem_int32[(SELF + 4) >> 2]) + 4 * i11) >> 2];
    var c = RGB();
...
Texture.bumpSample = function (SELF, u, v) {
    ...
    v = fract_add1(v);
    v = 1 - v;
    var w = turbo.Runtime._mem_int32[(SELF + 12) >> 2];
    var h = turbo.Runtime._mem_int32[(SELF + 8) >> 2];
    ...
    var cx = Color.sub_mem(turbo.Runtime._mem_int32[((turbo.Runtime._mem_int32[(SELF + 4) >> 2]) + 4 * (y * w + x1)) >> 2], turbo.Runtime._mem_int32[((turbo.Runtime._mem_int32[(SELF + 4) >> 2]) + 4 * (y * w + x2)) >> 2]);
    var cy = Color.sub_mem(turbo.Runtime._mem_int32[((turbo.Runtime._mem_int32[(SELF + 4) >> 2]) + 4 * (y1 * w + x)) >> 2], turbo.Runtime._mem_int32[((turbo.Runtime._mem_int32[(SELF + 4) >> 2]) + 4 * (y2 * w + x)) >> 2]);
